 ...
 *
 * $Id: Event.inc.php 563 2007-08-30 02:01:50Z stefan $
 */
...
class Event extends PLAN
{
	...
	function cloneIt ($expires, $cloneDates, $clonePeople, $cloneStatus)
	{
		$clone = new ClonedEvent ($this->getName (), $this->getOwner (),
				$expires, true, $cloneDates, $clonePeople,
						$cloneStatus, $this->_sumType);
