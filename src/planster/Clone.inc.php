 ...
 *
 * $Id: Clone.inc.php 554 2007-08-15 02:13:40Z stefan $
 */
...
class ClonedEvent extends PLAN
{
	var $_cloneOwner;
	var $_cloneDates;
	var $_clonePeople;
	...
	function ClonedEvent ($name, $owner, $expires, $_cloneOwner,
			$_cloneDates, $_clonePeople, $_cloneStatus, $sumType)
	{
		$this->setName ($name);
		$this->setOwner ($owner);
	...
	function _copyGroups ()
	{
		...
		return $groupList->cloneIt ($this->getID ());
	}
