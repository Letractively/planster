...
{/if}
	...
	<body>
		...
		<div id="progress" style="display: none">
			<img src="{$smarty.const.base_url}img/progress.gif" alt="" />
			<div id="text">Please wait...</div>
		</div>
		<h1 id="h1">{if $id}<a href="{$id}">{/if}{$title}{if $id}</a>{/if}</h1>
		<img src="img/logo.gif" alt="PLANster" title="" id="title" />
		<p id="product_note"><a href="http://www.planster.net/">PLANster</a> {$version}</p>
{$body}
		<p id="footer">
			&copy; 2004-2007 <a href="http://www.ott.net/">Stefan Ott</a>
			...
			&middot; <a href="http://www.ottwerk.net/"><img src="{$smarty.const.base_url}img/ottwerk.png" alt="ottwerk" /></a>
		</p>
