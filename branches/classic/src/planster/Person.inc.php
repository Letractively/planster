 ...
 *
 * $Id: Person.inc.php 570 2007-08-30 22:03:43Z stefan $
 */
...
class Person extends DBItem
{
	...
	function save ()
	{
		...
		if ($this->_id < 0)
		{
			...
			$change = new Change (CHANGE_TYPE_INVITE,
						$this->_eventID, $this->_name);
			$change->save ();
		}
		else
		{
	...
	function getStatusComment ($date)
	{
		die ("TODO");
	}

	function setStatusComment ($date, $comment)
	{
		die ("TODO");
	}
